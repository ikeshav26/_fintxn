        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-xs leading-relaxed text-slate-600">
              FinTxn National Trust & Savings Association is a member of the
              Federal Reserve System and a wholly owned subsidiary of FinTxn
              Financial Corp.
            </p>
      ...
      <div className="bg-[#002244] text-slate-300 py-4 sm:py-6 px-4 sm:px-8 border-t border-[#001122]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-4 sm:gap-6">
          ...
          <div className="text-[10px] text-center lg:text-right leading-relaxed opacity-70">
            Investment and insurance products are not FDIC insured, are not a
            bank deposit, are not guaranteed by the bank or any federal
            government agency, and may lose value.
            <br />© {currentYear} FinTxn National Trust & Savings Association.
            All Rights Reserved.
          </div>
        </div>
      </div>
