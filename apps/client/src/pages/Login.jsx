    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#f4f4f4] font-sans selection:bg-[#FFD700] selection:text-[#003366]">
      <div className="hidden lg:flex lg:w-[42%] bg-[#002244] text-white p-16 flex-col justify-between relative overflow-hidden border-r-8 border-[#FFD700]">
        ...
        <div className="absolute inset-0 opacity-[0.03] pointer-events-none" 
             style={{ backgroundImage: 'radial-gradient(#ffffff 1.5px, transparent 0)', backgroundSize: '32px 32px' }} />
        ...
        <div>
          <div className="flex items-center gap-4 group">
            ...
            <div>
              <span className="text-3xl font-black italic uppercase tracking-tighter block leading-none">FinTxn</span>
              <span className="text-[10px] uppercase tracking-[0.3em] text-slate-400 font-bold">National Trust & Savings</span>
            </div>
          </div>
          
          <Link to="/" className="mt-8 inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-[#FFD700] transition-colors">
          ...
          <div className="mt-20">
            ...
            <p className="text-slate-400 font-serif italic max-w-sm text-lg">
              Authorized personnel only. Accessing your secure financial records requires multi-factor authentication.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 pt-8 border-t border-white/[0.06] opacity-40">
            ...
            <span className="text-[9px] font-bold uppercase tracking-[0.4em]">256-Bit Encryption • Secure Login Access</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-5 sm:p-8 lg:p-12">
        <div className="lg:hidden w-full max-w-md flex items-center justify-between mb-10 border-b-2 border-slate-200 pb-4">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-black italic uppercase text-[#003366] tracking-tighter">FinTxn</span>
          </Link>
          <Link to="/" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-[#003366]">
            <Home size={16} />
          </Link>
        </div>
